...
export default function Profile() {
    ...
    const handleCopyLink = () => {
        const link = `https://linkspace-sb.vercel.app/userprofile/${uidd}`;
                        ...
                        <Modal show={showShareModal} onHide={handleCloseshareModal}>
                            ...
                            <Modal.Body className='frilist'>
                                ...
                                <div className='frilistdata' style={{ display: "flex" }}>
                                    <input type='text' value={`https://linkspace-sb.vercel.app/userprofile/${uidd}`} className='input1' disabled></input>
